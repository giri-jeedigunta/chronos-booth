...
import { Volume2, VolumeX, Play, Pause, Square, Music } from 'lucide-react';
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full">
      <div className="glass-card p-4 md:p-6 rounded-3xl border-blue-500/20 shadow-lg flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div>
            <h4 className="text-white font-bold leading-tight">{era.name} Ambient</h4>
            <p className="text-zinc-500 text-xs tracking-wider uppercase font-medium">Temporal Soundtrack</p>
          </div>
        </div>
